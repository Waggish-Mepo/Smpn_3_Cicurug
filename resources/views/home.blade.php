        ...
        <div class="mainContent">
            <div class="container">
                ...
                <div class="aboutSmpn" id="aboutSmpn">
                    ...
                    <div class="about">
                        <p>Untuk meningkatkan kualitas sumber daya manusia, Kementerian Pendidikan, Kebudayaan dan
                            Ristek (KemendikbudRistek) mencanangkan reformasi sistem pendidikan Indonesia melalui
                            kebijakan Merdeka Belajar. Hal ini ditegaskan kembali Menteri Pendidikan dan Kebudayaan
                            (Mendikbud).</p>
                    </div>
                </div>
                <!--End-->
