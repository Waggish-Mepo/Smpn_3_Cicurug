    ...
    <ul class="nav nav-pills mb-3 tabsMenu" id="pills-tab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="list-request-tab" data-bs-toggle="pill" data-bs-target="#listRequestTab"
                type="button" role="tab" aria-controls="listRequestTab" aria-selected="false">Daftar Berita</button>
        </li>
    </ul>
        ...
        <div class="wrapperTable table-responsive">
            <table id="bannerTable" class="tables" style="width:100%">
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td>Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi alias cumque architecto.
                            Recusandae corporis ad temporibus, quaerat maiores tempora voluptatum nulla blanditiis ab error
                            laboriosam tenetur magnam repellendus. Ipsum, fugit?<img src="" alt=""></td>
                        <td>
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="editBanner" tabindex="-1" aria-labelledby="editBannerLabel"
                                aria-hidden="true">
